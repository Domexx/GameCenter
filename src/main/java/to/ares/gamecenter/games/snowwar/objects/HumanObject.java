...
public class HumanObject extends BaseObject {
    ...
    public HumanObject(SnowWarRoom room, int teamId) {
        super(19);
    ...
    public void decrementHealth(HumanObject attacker, int rot) {
    ...
    public void giveScorePerHit(HumanObject _arg2) {
    ...
    public void giveScorePerKill(HumanObject _arg2) {
        if (team != _arg2.team || SnowWar.TEAMS.length == 1) {
            kills++;
    ...
    @Override
    public boolean testSnowBallCollision(SnowBallObject snowBall) {
    ...
    @Override
    public void onSnowBallHit(SnowBallObject snowBall) {
        final HumanObject attacker = snowBall.getAttacker();
