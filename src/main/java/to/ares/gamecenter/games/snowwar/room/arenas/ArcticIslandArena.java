...
public class ArcticIslandArena extends BaseArena {
	...
	public void gameObjects(final Map<Integer, BaseObject> gameObjects, SnowWarRoom room) {
		gameObjects.put(0, new TreeObject(19, 41, 0, 1, 3, 3, 0, room.map, room));
		gameObjects.put(1, new TreeObject(9, 31, 0, 1, 5, 3, 0, room.map, room));
		gameObjects.put(2, new TreeObject(25, 38, 0, 1, 9, 3, 0, room.map, room));
		gameObjects.put(3, new TreeObject(49, 28, 0, 1, 15, 3, 0, room.map, room));
		gameObjects.put(4, new TreeObject(36, 15, 0, 1, 22, 3, 0, room.map, room));
		gameObjects.put(5, new TreeObject(47, 32, 0, 1, 24, 3, 0, room.map, room));
		gameObjects.put(6, new TreeObject(6, 20, 0, 1, 28, 3, 0, room.map, room));
		gameObjects.put(7, new TreeObject(26, 6, 0, 1, 31, 3, 0, room.map, room));
		gameObjects.put(8, new TreeObject(10, 26, 0, 1, 34, 3, 0, room.map, room));
		gameObjects.put(9, new TreeObject(13, 15, 0, 1, 39, 3, 0, room.map, room));
		gameObjects.put(10, new TreeObject(30, 7, 0, 1, 42, 3, 0, room.map, room));
		gameObjects.put(11, new TreeObject(15, 10, 0, 1, 48, 3, 0, room.map, room));
		gameObjects.put(12, new TreeObject(20, 4, 0, 1, 50, 3, 0, room.map, room));
		gameObjects.put(13, new TreeObject(45, 25, 0, 1, 56, 3, 0, room.map, room));
		gameObjects.put(14, new TreeObject(28, 47, 0, 1, 73, 3, 0, room.map, room));
		gameObjects.put(15, new MachineObject(26, 24, 0, 5, 0, 75, room.map, room));
		gameObjects.put(16, new TreeObject(5, 24, 0, 1, 76, 3, 0, room.map, room));
		gameObjects.put(17, new TreeObject(20, 8, 0, 1, 80, 3, 0, room.map, room));
		gameObjects.put(18, new TreeObject(15, 34, 0, 1, 92, 3, 0, room.map, room));
	}
