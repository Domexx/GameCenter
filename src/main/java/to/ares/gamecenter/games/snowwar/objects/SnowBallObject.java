...
public class SnowBallObject extends BaseObject {
    ...
    private int speed;
    private int ttl;
    private HumanObject ballOwner;
    private int paraOffs;

    public SnowBallObject(final SnowWarRoom room){
    	super(11);
		currentSnowWar = room;
    ...
    private void setOwner(HumanObject val) {
		if(val == null) {
    ...
    public void initialize(int x, int y, int type, int destX, int destY, HumanObject owner) {
    ...
    public HumanObject getAttacker(){
        return (ballOwner);
    }
